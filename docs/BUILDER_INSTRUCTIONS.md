...
Antes de crear un archivo nuevo, pregúntate: *¿Existe algo parecido que pueda adaptar?*
...
El CSS debe escribirse para pantallas pequeñas por defecto. Las *media queries* son para pantallas grandes.
